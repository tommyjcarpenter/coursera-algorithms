...
func getjobs(fname string) heap.MaxPQ {
	...
	for lindex, l := range lines {
		...
		// when a node is popped, lindex will be used to pull out the original items
		// a fancier solution woudl be to override vertex and attach these as satelite data
